...
<div class="test-container">
    ...
    <div class="test-section">
        <h2>Manual Test</h2>
        <p>Try hovering over the "الأجهزة" menu item in the navigation bar above. The dropdown menu should appear.</p>
    </div>
    ...
    <div class="test-section">
        ...
        <div id="summary" class="result">
            This page tests if the device menu navigation is working correctly on all pages.
            The issue was that the navigation JavaScript in topBarNav.php was conflicting with
            the site-wide JavaScript in site-wide.js. We resolved this by:
            
            1. Removing the conflicting initMegaMenu() call from site-wide.js
            2. Ensuring AJAX paths use correct relative paths
            3. Adding CSS rules to ensure the mega menu is visible on hover
            4. Increasing the z-index to ensure the menu appears above other elements
            
            If the manual hover test works and all automated tests pass, the navigation issue has been resolved.
        </div>
    </div>
</div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    document.getElementById('test-functions').addEventListener('click', function() {
        ...
        try {
            ...
            result += 'loadBrandCategoriesFromServer: ' + (typeof loadBrandCategoriesFromServer !== 'undefined' ? 'Available' : 'Not Available') + '\n';
            result += 'loadCategoryModelsFromServer: ' + (typeof loadCategoryModelsFromServer !== 'undefined' ? 'Available' : 'Not Available') + '\n';
