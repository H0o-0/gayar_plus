...
if(isset($_GET['id']) && $_GET['id'] > 0){
    $qry = $conn->query("SELECT * from `series` where id = '{$_GET['id']}' ");
    if($qry->num_rows > 0){
...
<div class="card card-outline card-info">
	<div class="card-header">
		<h3 class="card-title"><?php echo isset($id) ? "Update ": "Create New " ?> Series</h3>
	</div>
	<div class="card-body">
		<form action="" id="series-form">
	...
	<div class="card-footer">
		<button class="btn btn-flat btn-primary" form="series-form">Save</button>
		<a class="btn btn-flat btn-default" href="?page=series">Cancel</a>
	</div>
</div>
<script>
	...
	$(document).ready(function(){
		...
		$('#series-form').submit(function(e){
			...
			start_loader();
			$.ajax({
				url:_base_url_+"classes/Master.php?f=save_series",
