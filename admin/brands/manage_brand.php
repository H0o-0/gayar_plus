...
<div class="card card-outline card-info">
	<div class="card-header">
		<h3 class="card-title"><?php echo isset($id) ? "Update ": "Create New " ?> Brand</h3>
	</div>
	<div class="card-body">
		<form action="" id="brand-form">
            ...
            <div class="form-group">
				<label for="name_ar" class="control-label">Brand Name (Arabic) - اسم العلامة التجارية</label>
	...
	<div class="card-footer">
		<button class="btn btn-flat btn-primary" form="brand-form">Save</button>
		<a class="btn btn-flat btn-default" href="?page=brands">Cancel</a>
	</div>
</div>
<script>
