...
if (file_exists($initialize_path)) {
    ...
    try {
            ...
            if ($conn->ping()) {
                ...
                if ($result) {
                    ...
                    if ($result) {
                        ...
                        error_log("Error accessing brands table: " . $conn->error);
                    }
                } else {
                    echo "<p>Error executing simple query: " . $conn->error . "</p>";
                    error_log("Error executing simple query: " . $conn->error);
                }
            } else {
        ...
        error_log("Error including initialize.php: " . $e->getMessage());
